...
public class EquipoProgramacion {
	...
	public EquipoProgramacion(String nombreEquipo, String universidad, String lenguajedeProgramacion,
			int numdProgramadores) {
	...
	public void agregarProgramador(Programador programador) throws Exception {
		if (estaCompleto()) {
			System.out.println("el numero de programadores es. " + numdProgramadores);
	...
	public int ObtenerNumProgramadoresValido() throws Exception {
		...
		//System.out.println("El número de programadores es. " + numdProgramadores);
